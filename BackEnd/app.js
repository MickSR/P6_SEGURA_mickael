...
app.use((req, res, next) => {
  // passer la sécurité CORS , on autorise toutes les origines à accéder à notre API
...
app.use(
  express.urlencoded({ extended: true }) // méthode intégrée à express pour reconnaître l'objet de requête entrant sous forme de chaînes ou de tableaux
);
